...
export default function CustomizeOrderModal({ sheetRef }) {
  const CustomRadionButton = ({ isSelected, onPress, style, name }) => {
    return (
      <View
        style={[
          style,
      ...
      >
        <TouchableOpacity activeOpacity={0.7} onPress={onPress}>
          <Icon
            name={isSelected ? "checkmark-circle-sharp" : "radio-button-off"}
  ...
  const renderContent = () => (
    ...
    >
      ...
      <View style={{ marginTop: SIZES.twenty }}>
        ...
        >
          <CustomRadionButton name={"Plain"} />
          <CustomRadionButton name={"Crust"} isSelected={true} />
          <CustomRadionButton name={"Thin"} />
        </View>
      </View>
  ...
  return (
    <>
      ...
      <BottomSheet
        ...
        initialSnap={2}
        snapPoints={[height - SIZES.twenty * 7, 100, 0]}
        // borderRadius={}
